...
public class SetupAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nombre = (EditText) findViewById(R.id.admsetup_nombre);
        ciudad = (EditText) findViewById(R.id.admsetup_ciudad);
        direccion=(EditText)findViewById(R.id.admsetup_direccion);
        telefono = (EditText) findViewById(R.id.admsetup_telefono);
        guardar = (Button) findViewById(R.id.admsetup_boton);
        imagen=(CircleImageView) findViewById(R.id.admsetup_imagen);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    if(snapshot.hasChild("imagen")){
                        ...
                        Toast.makeText(SetupAdminActivity.this, "Selecciona una imagen de perfil", Toast.LENGTH_SHORT).show();
                    }
                }
            }
                                    ...
                                    UserRef.child(CurrentUserId).child("imagen").setValue(downloadUri).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                ...
                                                Toast.makeText(SetupAdminActivity.this, "Error", Toast.LENGTH_SHORT).show();
                                                dialog.dismiss();
                                            }
                                        }
                                    });
    ...
    private void EnviaralInicio(){
        Intent i = new Intent(SetupAdminActivity.this, AdminActivity.class);
